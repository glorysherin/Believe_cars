"""
Django settings for believe_cars project.
...
SECRET_KEY = 'django-insecure-zf3k*qhie32pz4*iut6y#wr-!k43-_7_dc(olb9goz@8av+tro'
...
ROOT_URLCONF = 'believe_cars.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Adjust this to your project structure
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'believe_cars.wsgi.application'
